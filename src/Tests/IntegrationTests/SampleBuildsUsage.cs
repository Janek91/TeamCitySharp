...
namespace TeamCitySharp.IntegrationTests
{
    ...
    public class when_interacting_to_get_build_status_info
    {
        ...
        public void it_returns_last_successful_build_by_build_config_id()
        {
            ...
            Build build = m_client.Builds.LastSuccessfulBuildByBuildConfigId(buildConfigId);
        ...
        {
            string buildConfigId = m_goodBuildConfigId;
            List<Build> buildDetails = m_client.Builds.SuccessfulBuildsByBuildConfigId(buildConfigId);
        ...
        {
            string buildConfigId = m_goodBuildConfigId;
            Build buildDetails = m_client.Builds.LastFailedBuildByBuildConfigId(buildConfigId);
        ...
        {
            string buildConfigId = m_goodBuildConfigId;
            List<Build> builds = m_client.Builds.FailedBuildsByBuildConfigId(buildConfigId);
        ...
        {
            string buildConfigId = m_goodBuildConfigId;
            Build buildDetails = m_client.Builds.LastErrorBuildByBuildConfigId(buildConfigId);
        ...
        public void it_returns_all_error_builds_by_config_id()
        {
            ...
            List<Build> builds = m_client.Builds.ErrorBuildsByBuildConfigId(buildId);
        ...
        {
            string buildConfigId = m_goodBuildConfigId;
            Build build = m_client.Builds.LastBuildByBuildConfigId(buildConfigId);
        ...
        {
            string buildConfigId = m_goodBuildConfigId;
            List<Build> builds = m_client.Builds.ByBuildConfigId(buildConfigId);
        ...
        public void it_returns_all_builds_by_build_config_id_and_tag()
        {
            ...
            List<Build> builds = m_client.Builds.ByConfigIdAndTag(buildConfigId, tag);
        ...
        public void it_returns_all_builds_by_username()
        {
            ...
            List<Build> builds = m_client.Builds.ByUserName(userName);
        ...
        {
            string userName = m_username;
            List<Build> builds = m_client.Builds.NonSuccessfulBuildsForUser(userName);
        ...
        {
            List<Build> builds = m_client.Builds.ByBuildLocator(BuildLocator.RunningBuilds());
        ...
        {
            List<Build> builds = m_client.Builds.AllBuildsOfStatusSinceDate(DateTime.Now.AddDays(-2), BuildStatus.FAILURE);
        ...
        public void it_returns_correct_build_when_calling_by_id()
        {
            ...
            Build build = client.Builds.ById(buildId);
        ...
        public void it_returns_correct_next_builds()
        {
            ...
            List<Build> builds = client.Builds.NextBuilds(buildId, 10);
        ...
        public void it_returns_correct_next_builds_with_filter()
        {
            ...
            List<Build> builds = client.Builds.GetFields(buildsField.ToString()).NextBuilds(buildId, 10);

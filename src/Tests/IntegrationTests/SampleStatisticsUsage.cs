...
namespace TeamCitySharp.IntegrationTests
{
    ...
    public class when_interacting_to_get_build_statistics
    {
        ...
        {
            Project proj = m_client.Projects.ById("AutoFixture");
            Build build = m_client.Builds.LastSuccessfulBuildByBuildConfigId(proj.BuildTypes.BuildType[0].Id);
            List<Property> stats = m_client.Statistics.GetByBuildId(build.Id);

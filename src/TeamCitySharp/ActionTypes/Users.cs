...
namespace TeamCitySharp.ActionTypes
{
    internal class Users : IUsers
    {
        ...
        {
            UserWrapper userWrapper = m_caller.Get<UserWrapper>("/app/rest/users");
        ...
        {
            User user = m_caller.GetFormat<User>("/app/rest/users/username:{0}", userName);
        ...
        {
            UserGroupWrapper userGroupWrapper = m_caller.Get<UserGroupWrapper>("/app/rest/userGroups");
        ...
        {
            Group group = m_caller.GetFormat<Group>("/app/rest/userGroups/key:{0}", userGroupName);
        ...
        public bool Create(string username, string name, string email, string password)
        {
            ...
            HttpResponse createUserResponse = m_caller.Post(data, HttpContentTypes.ApplicationXml, "/app/rest/users", string.Empty);
        ...
        public bool AddPassword(string username, string password)
        {
            ...
            HttpResponse response = m_caller.Put(password, HttpContentTypes.TextPlain,

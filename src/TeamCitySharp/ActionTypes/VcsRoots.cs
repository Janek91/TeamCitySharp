...
namespace TeamCitySharp.ActionTypes
{
    public class VcsRoots : IVcsRoots
    {
        ...
        {
            VcsRoots newInstance = (VcsRoots)MemberwiseClone();
        ...
        {
            VcsRootWrapper vcsRootWrapper = m_caller.Get<VcsRootWrapper>(ActionHelper.CreateFieldUrl("/app/rest/vcs-roots", m_fields));
        ...
        {
            VcsRoot vcsRoot = m_caller.GetFormat<VcsRoot>(ActionHelper.CreateFieldUrl("/app/rest/vcs-roots/id:{0}", m_fields),
                                                     vcsRootId);
        ...
        {
            string xml = $@"<vcs-root-entry><vcs-root id=""{vcsRoot.Id}""/></vcs-root-entry>";
        ...
        public VcsRoot CreateVcsRoot(VcsRoot vcsRoot, string projectId)
        {
            ...
            string data = writer.Write(vcsRoot);

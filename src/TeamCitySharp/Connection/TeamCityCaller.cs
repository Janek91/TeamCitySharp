...
namespace TeamCitySharp.Connection
{
    internal class TeamCityCaller : ITeamCityCaller
    {
        ...
        public void GetDownloadFormat(Action<string> downloadHandler, string urlPart, params object[] parts)
        {
            ...
            string url = CreateUrl(string.Format(urlPart, parts));
        ...
        public string StartBackup(string urlPart)
        {
            ...
            HttpClient httpClient = CreateHttpClient(m_configuration.UserName, m_configuration.Password, HttpContentTypes.TextPlain);
            HttpResponse response = httpClient.Post(url, null, HttpContentTypes.TextPlain);
        ...
        {
            HttpResponse response = GetResponse(urlPart);
        ...
        public bool Authenticate(string urlPart, bool throwExceptionOnHttpError = true)
        {
            try
            {
                ...
                HttpResponse response = httpClient.Response;
        ...
        {
            HttpClient client = MakePostRequest(data, contenttype, urlPart, accept);
        ...
        {
            HttpClient client = MakePutRequest(data, contenttype, urlPart, accept);
        ...
        {
            HttpClient client = CreateHttpClient(m_configuration.UserName, m_configuration.Password, HttpContentTypes.TextPlain);
        ...
        {
            HttpClient client = CreateHttpClient(m_configuration.UserName, m_configuration.Password,
        ...
        {
            int num = (int)response.StatusCode / 100;
        ...
        {
            string protocol = m_configuration.UseSSL ? "https://" : "http://";
            string authType = m_configuration.ActAsGuest ? "/guestAuth" : "/httpAuth";
        ...
        {
            HttpClient httpClient = new HttpClient(new TeamcityJsonEncoderDecoderConfiguration()) { Request = { Accept = accept } };
            if (m_useNoCache)
            {
        ...
        {
            string urlfull = string.Format(urlPart, parts);
